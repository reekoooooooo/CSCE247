...
public class CourseDriver {
	...
	public CourseDriver() {
		...
		csce247.addAssignment("Strategy Design Pattern", "Implement the Strategy Design Pattern to build robots",
		...
		csce247.addAssignment("Requirements - Part 1", "Complete project proposal, competitive analysis and personas",
				Topic.PROJECT);
		csce247.addAssignment("Observer Design Pattern", "Implement the Observer Design Pattern to simulate a baby cry",
				Topic.DESIGN_PATTERN);
	 ...
	 * 
	 * @return A number between 0 and 4 corresponding to their option
	 */
	private int getNum() {
		int num;
